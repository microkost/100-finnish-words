    ...
    public static class Dictionary
    {
        ...
        public static List<Phrase> GetListOfWords()
        {
            ...
            List<Phrase> dict = new List<Phrase>() //manually managed
            {
                ...
                new Phrase("Eri", "Different", "Jiný", "Różne"),
                ...
                new Phrase("Juuri", "Just", "Prostě", "Właśnie"),
                new Phrase("Kuva", "Picture", "Obrázek", "Obrazek"),
                ...
                new Phrase("Kerta", "Time", "Pokaždé", "Razem"),
